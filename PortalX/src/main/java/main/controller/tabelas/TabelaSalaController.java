...
public class TabelaSalaController implements Initializable {

    TabelaSalaController tabelaController;

    public void defineTabelaController(TabelaSalaController tabelaController) {
