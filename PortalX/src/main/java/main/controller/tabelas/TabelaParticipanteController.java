...
public class TabelaParticipanteController implements Initializable {

    TabelaParticipanteController tabelaController;

    public void defineTabelaController(TabelaParticipanteController tabelaController) {
